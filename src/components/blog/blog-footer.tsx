...
export function BlogFooter() {
  ...
  return (
    <footer className="bg-black text-white section-padding mt-0">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="https://www.instagram.com/sullyrealtygroup/"
        ...
        <div className="text-center space-y-3 mb-8">
          <p className="body-sm text-white/60">
            {businessInfo.brokerage} &middot; {businessInfo.address.street},{" "}
            {businessInfo.address.city}, {businessInfo.address.state}{" "}
            {businessInfo.address.zip} &middot; TREC License #
